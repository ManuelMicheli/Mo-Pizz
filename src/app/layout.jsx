    ...
    return (
        <html lang="it" translate="no" className={`${geistMono.variable} ${caveat.variable}`}>
            <head>
                ...
                <link rel="preload" as="image" href="/images/gift-card-envelope.webp" fetchPriority="low" />
                <link rel="preload" as="image" href="/images/pizza-box-color.webp" fetchPriority="low" />
