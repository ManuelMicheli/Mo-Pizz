...
const Chef = () => {
    ...
    return (
        <section id="chef" ref={cRef} className="w-full relative flex flex-col md:flex-row min-h-[80vh] overflow-hidden bg-flour md:bg-transparent">
            ...
            <div className="w-full md:w-[45%] bg-flour flex items-center justify-center p-12 lg:p-24 relative overflow-hidden">
            ...
            <div className="w-full md:w-[55%] bg-charcoal flex flex-col justify-center px-8 sm:px-16 md:px-20 lg:px-32 py-20 relative">
                ...
                {/* Quote Block */}
                <div className="chef-text relative mt-16 pl-10 md:pl-16">
                    <span className="font-serif text-gold text-8xl absolute -top-8 left-0 leading-none opacity-40">"</span>
                    <p className="font-caveat text-3xl sm:text-4xl lg:text-5xl text-cream italic leading-snug">
