...
const MenuVideoIntro = () => {
  ...
  return (
    ...
    >
      ...
      <div className="menu-video-content absolute bottom-8 right-6 sm:bottom-10 sm:right-12 md:right-20 lg:right-32 z-10 flex flex-col items-end text-right max-w-[380px] sm:max-w-[440px]">
