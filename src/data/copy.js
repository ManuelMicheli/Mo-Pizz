...
export const siteContent = {
  ...
  staff: {
    ...
    paragraphs: [
      ...
      'Al centro del progetto c\'è una squadra che lavora con lo stesso ritmo: **Christian** al forno, **Carmine e Alessia** dietro le quinte, **il cuoco** che porta la sua formazione del sud tra primi di mare e secondi di terra, e uno **staff giovane** che ha costruito, sera dopo sera, un modo tutto suo di accogliere le persone, diretto, autentico, senza copione.',
